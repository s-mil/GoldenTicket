...
{
    name=Client,
    description={The person/entitity that requests a service from the service company(users of the tickting system.}
}
\newglossaryentry{technician}
{
    name=Technician,
    description={The person/entitity that works a ticket}
}
\newglossaryentry{administrator}
{
    name=Client,
    description={The person/entitity that manages technicians and client relations, has the power to make tickets priority}
}
\begin{document}
\begin{titlepage}
...
\begin{enumerate}
	...
	\item A \index{ticket} will consist of the following items:
	      \begin{itemize}
		      \item Title
		      \item Description
		      ...
		      \item due date/ time
	      \end{itemize}
	\item A \index{contact} will consist of the following items:
	      \begin{itemize}
		      \item Name
		      \item Phone number
		      \item Email address
	      ...
	      \end{itemize}
	\item a \index{company} will consist of the following items:
	      \begin{itemize}
		      \item A list of contacts
		      \item A list of associated tickets
		      \item join date
	      \end{itemize}
  \item A \index{Technician} will consist of the following items:
        \begin{itemize}
          \item Join date
        ...
        \end{itemize}
  \item An \index{administrator} will consist of the following items:
        \begin{itemize}
          \item
        \end{itemize}
\end{enumerate}
...
\subsection{Hardware Dependencies for host}
  ...
  \subsection{\index{Software Dependencies for client}}
    \begin{itemize}
      \item A modern web browser (edge / firefox / chrome)
    \end{itemize}

    \subsection{\index{Hardware Dependencies for client}}
      \begin{itemize}
